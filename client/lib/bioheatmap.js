...
Options:
 ...
 startColor	Object	{r: 0, g: 255, b: 0, a: 1 }	Defaults to green. This is a simple object with red, green, blue and alpha attributes set.Valid r/g/b values range from 0 to 255. Valid a values range from 0 to 1.
 endColor	Object	{r: 255, g: 0, b: 0, a: 1 }	Defaults to red. This is a simple object with red, green, blue and alpha attributes set.Valid r/g/b values range from 0 to 255. Valid a values range from 0 to 1.
 emptyDataColor	Object	{r: 100, g: 100, b: 100, a: 1 }	Defaults to gray. This is a simple object with red, green, blue and alpha attributes set.Valid r/g/b values range from 0 to 255. Valid a values range from 0 to 1.
 ...
 passThroughBlack	boolean	true	If set to true, black is set as the center color between startColor and endColor. When set to false, the colors range directly from startColor to endColor.
 ...
 mapWidth	integer	 	The absolute width of the visualization area. When mapWidth and mapHeight are specified, the cellHeight and cellWidth are interpolated and set to square.
 mapHeight	integer	 	The absolute width of the visualization area. When mapWidth and mapHeight are specified, the cellHeight and cellWidth are interpolated and set to square.
 ...
 Methods
 -------
 draw(data, options)	none	Draws the heatmap.
 getSelection()	Array of selection elements	Standard getSelection implementation. Selection elements are cells when a heatmap cell is clicked, rows when a row label is clicked and columns when a column label is clicked.
 setSelection(selection)	none	Standard setSelection implementation. Currently there are no visual changes to selected items.
...
// -
// ---------------------------------------------------------------------------------------------------------------------
org.systemsbiology.visualization.BioHeatMap = function(container) {
    this.initialize(container);
};

$.extend(org.systemsbiology.visualization.BioHeatMap.prototype, {
    // --------------------------------------------------------
    // PUBLIC METHODS
    // --------------------------------------------------------
...
org.systemsbiology.visualization.DiscreteColorRange = function(maxColors,dataRange,options) {
    this.initialize(maxColors,dataRange,options);
};

$.extend(org.systemsbiology.visualization.DiscreteColorRange.prototype, {
    // --------------------------------
    // constants
    // --------------------------------
    MINCOLORS: 2,
