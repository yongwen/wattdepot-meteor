...
Router.map(function() {
  ...
  this.route('visHourly', {
    path: '/vis_hourly/:_id',
    // subscribe to measurements before the page is rendered but don't wait on the
    // subscription, we'll just render the items as they arrive
    onBeforeAction: function () {
      this.hourlyMeasurementsHandle = Meteor.subscribe('h_measurements', this.params._id);
    ...
    this.route('visDaily', {
        ...
        // subscription, we'll just render the items as they arrive
        onBeforeAction: function () {
            this.dailyMeasurementsHandle = Meteor.subscribe('d_measurements', this.params._id);
